...
> **Created by**: Student Talent Development
...
```
[Browser only]
   ├── index.html (UI and browser behavior)
   ├── content/app-content.js (canonical bilingual content)
   ├── js/assessment-core.js (scoring)
...
Authoring mode (`?edit=1`) is separate from the public assessment and may use
`localStorage` for local drafts. Public assessment mode must not write browser
storage.
...
- **Creator**: Student Talent Development
- **Affiliation**: Faculty of Engineering, Chiang Mai University
- **Framework source**: LinkedIn AI Upskilling Framework (with link to original article)

### 5.3 Where attribution appears

1. **Footer ของทุกหน้า**:
   - TH/EN: "© 2026 Student Talent Development · Faculty of Engineering, Chiang Mai University"
...
3. **Downloadable image (footer)**:
   ...
   - TH version: "© 2026 Student Talent Development · CMU · อิง LinkedIn AI Upskilling Framework"
   - EN version: "© 2026 Student Talent Development · CMU · Based on LinkedIn AI Upskilling Framework"

4. **PDF print version**: เหมือน footer

### 5.4 README/repo
- ใส่ `LICENSE` file พร้อมเงื่อนไขหลักและลิงก์ไปยัง legal code ของ CC BY-NC-SA 4.0
...
│  © 2026 Student Talent Development    │
...
- [ ] Public mode writes 0 cookies / localStorage / sessionStorage (authoring mode excluded)

**Legal/Credit**
- [ ] Copyright Student Talent Development ใน footer ทุกหน้า + ในภาพ + ใน PDF
